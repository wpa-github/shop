				...
				<form action="">
					...
					<dl>
						...
						<dd>
							...
							<img id="login-code" src="../system/get_cpacha" alt="" align="absmiddle" style="position:relative;top:-2px;" width="100px" height="30px"/> <a href="javascript:changeCode()" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
...
<script>
	function changeCode(){
		$("#login-code").attr('src','../system/get_cpacha?t='+new Date().getTime());
	}
