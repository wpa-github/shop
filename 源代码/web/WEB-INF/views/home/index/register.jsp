				...
				<form>
					...
					<dl>
						...
						<dd>
							...
							<img id="register-code" src="../system/get_cpacha" alt="" align="absmiddle" style="position:relative;top:-2px;"/> <a href="javascript:changeCode()" style="color:#999;">看不清，换一张</a></dd>
					</dl>
					<dl>
						<dt>&nbsp;</dt>
...
<script>
	function changeCode(){
		$("#register-code").attr('src','../system/get_cpacha?t='+new Date().getTime());
	}
